<div class="modal-dialog modal-xl" role="document">
	<form action="{{ action('ContactController@update', $contact->id) }}" method="POST" id="contactForm">
		@method('PATCH')
		@csrf
  <div class="modal-content">
  	<div class="modal-header">
		<button type="button" class="close no-print" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		<h4 class="modal-title" id="modalTitle">Edit Contact
		</h4>
	</div>
	  ...
	  <div class="row">
	    <div class="col-sm-6">
	    	...
	    	<div class="form-group">
	    		...
	    		<input type="text" name="phone_no" id="phone_no" value="{{ $contact->phone_no }}" class="form-control">
	    	</div>
	    </div>
	  </div>
	</div>
